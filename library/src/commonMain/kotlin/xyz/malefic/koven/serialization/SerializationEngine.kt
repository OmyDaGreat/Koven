...
interface SerializationEngine<Format : SerialFormat> {
    ...
    companion object {
        ...
        init {
            ...
            registerIssue<AuthIssue.AccountLinkingRequired>()
            registerIssue<AuthIssue.OAuthIssue.TokenExchangeFailed>()
            registerIssue<AuthIssue.OAuthIssue.UserInfoFetchFailed>()
            registerIssue<AuthIssue.OAuthIssue.ProviderUserMappingFailed>()
