package xyz.malefic.koven.auth.model
 ...
 * @property expiresInDays How many days until the key expires. Falls back to [xyz.malefic.koven.auth.AuthType.ApiKey.defaultTtl] when null.
 */
@Serializable
